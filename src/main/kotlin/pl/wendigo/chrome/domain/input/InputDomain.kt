...
for example an emoji keyboard or an IME.
     */
    fun insertText(input: InsertTextRequest): io.reactivex.Single<pl.wendigo.chrome.ResponseFrame> {
        return connectionRemote.runAndCaptureResponse("Input.insertText", input, pl.wendigo.chrome.ResponseFrame::class.java).map {
            it.value()
        }
    }
